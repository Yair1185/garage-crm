...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchAdminData = async () => {
      try {
        const res = await axios.get('https://garage-crm-app.onrender.com/admin/dashboard', { withCredentials: true });
  ...
  useEffect(() => {
    const fetchChartData = async () => {
      try {
        const res = await axios.get('https://garage-crm-app.onrender.com/admin/appointments-per-day', { withCredentials: true });
